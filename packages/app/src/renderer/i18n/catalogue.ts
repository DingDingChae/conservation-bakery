...
export const CATALOGUE_KEYS = [
  ...
  // -- Faceplate (renderer/faceplate/render.ts) — no shared equivalent exists yet -----
  'faceplate.notFound',
  'faceplate.palette.tag',
  'faceplate.setpoint.enterNumber',
  'faceplate.setpoint.enterValue',
  'faceplate.setpoint.hint',
  'faceplate.setpoint.title',
  'faceplate.tag.pv',
  'faceplate.tag.range',
  'faceplate.tag.sp',
  'faceplate.tag.status.deviationHigh',
  'faceplate.tag.status.deviationLow',
  'faceplate.tag.status.noSetpoint',
  'faceplate.tag.status.withinTolerance',
  'faceplate.trend.columnPv',
  'faceplate.trend.columnSp',
  'faceplate.trend.columnTick',
  'faceplate.trend.legendPv',
  'faceplate.trend.legendSp',
  'faceplate.trend.svgDesc',
  'faceplate.trend.svgDescEmpty',
  'faceplate.trend.svgTitle',
  'faceplate.trend.tableCaption',
  'faceplate.trend.tableToggle',
  'faceplate.trend.title',

  // -- Command palette (renderer/palette/palette.ts) ----------------------------------
  'palette.caseSensitive',
  'palette.close',
  'palette.patternMode.contains',
  'palette.patternMode.legend',
  'palette.patternMode.literal',
  'palette.patternMode.prefix',
  'palette.patternMode.regex',
  'palette.patternMode.suffix',
  'palette.patternMode.wholeWord',
  'palette.runFailed',
  'palette.usePattern',

  // -- Ancestry lookup form (renderer/provenance/tree.ts) -----------------------------
  'provenance.tree.loadFailed',
  'provenance.tree.loading',
  'provenance.tree.lookupLabel',
  'provenance.tree.lookupSubmit',

  // -- Shell chrome (renderer/shell/header.ts, navRail.ts, settings.ts, fault.ts,
  // renderer/main.ts) -------------------------------------------------------------
  'shell.appTitle',
  'shell.fault.body',
  'shell.fault.detailUnavailable',
  'shell.fault.heartbeatLost',
  'shell.fault.noBridge',
  'shell.fault.title',
  'shell.header.annunciatorActive',
  'shell.header.annunciatorLabel',
  'shell.header.annunciatorOk',
  'shell.header.clock',
  'shell.header.noSnapshot',
  'shell.nav.ancestry',
  'shell.nav.balance',
  'shell.nav.settings',
  'shell.nav.title',
  'shell.nav.openMachine',
  'shell.nav.search.label',
  'shell.nav.search.placeholder',
  'shell.nav.search.resultsCount',
  'shell.nav.group.milling',
  'shell.nav.group.creamery',
  'shell.nav.group.refinery',
  'shell.nav.group.mixing',
  'shell.nav.group.ovens',
  'shell.nav.group.finishing',
  'shell.nav.group.sales',
  'shell.nav.group.other',
  'shell.settings.callSupplierAccepted',
  'shell.settings.callSupplierInvalidMass',
  'shell.settings.callSupplierMass',
  'shell.settings.callSupplierSubstance',
  'shell.settings.difficultyNote',
  'shell.settings.languageLabel',
  'shell.settings.registerLabel',

  // -- Cake designer (renderer/designer/panel.ts, logic.ts) ---------------------------
  'designer.title',
  'designer.subtitle',
  'designer.verdict.accepted',
  'designer.verdict.refused',
  'designer.announce.accepted',
  'designer.announce.refused',

  'designer.elevation.title',
  'designer.elevation.svgTitle',
  'designer.elevation.svgDesc',
  'designer.elevation.tableToggle',
  'designer.elevation.tableCaption',
  'designer.elevation.columnTier',
  'designer.elevation.columnDiameter',
  'designer.elevation.columnHeight',

  'designer.tier.add',
  'designer.tier.remove',
  'designer.tier.legend',
  'designer.tier.diameterLabel',
  'designer.tier.dowelledLabel',
  'designer.tier.dowelCountLabel',
  'designer.tier.layerMassLabel',
  'designer.tier.layerFormulationLabel',

  'designer.filling.add',
  'designer.filling.remove',
  'designer.filling.legend',
  'designer.filling.substanceLabel',
  'designer.filling.massLabel',

  'designer.finish.add',
  'designer.finish.remove',
  'designer.finish.legend',
  'designer.finish.kindLabel',
  'designer.finish.substanceLabel',
  'designer.finish.massLabel',
  'designer.finish.elapsedLabel',
  'designer.finish.kind.crumbCoat',
  'designer.finish.kind.icing',
  'designer.finish.kind.buttercream',
  'designer.finish.kind.ganache',
  'designer.finish.kind.fondant',
  'designer.finish.kind.piping',
  'designer.finish.kind.transfer',

  'designer.topper.add',
  'designer.topper.remove',
  'designer.topper.legend',
  'designer.topper.tierLabel',
  'designer.topper.substanceLabel',
  'designer.topper.massLabel',

  'designer.formulation.poundCake',
  'designer.formulation.genoise',

  'designer.substance.butter',
  'designer.substance.sucrose',
  'designer.substance.cocoaButter',
  'designer.substance.honey',
  'designer.substance.cream',
  'designer.substance.gelatin',
  'designer.substance.cherry',
  'designer.substance.strawberry',
  'designer.substance.goldLeaf',

  'designer.structure.title',
  'designer.structure.problem.emptyTier',
  'designer.structure.problem.tierOverloadedNoDowels',
  'designer.structure.problem.insufficientDowels',
  'designer.structure.problem.overhangingTier',

  'designer.thermal.title',
  'designer.thermal.problem.fondantTooWarm',
  'designer.thermal.problem.ganacheTooWarm',
  'designer.thermal.problem.buttercreamFamilyTooWarm',

  'designer.feasibility.title',
  'designer.feasibility.problem.missingEquipment',
  'designer.feasibility.problem.insufficientTime',
  'designer.feasibility.problem.insufficientStock',

  'designer.cost.title',
  'designer.cost.material',
  'designer.cost.labor',
  'designer.cost.total',
  'designer.cost.incomplete',
] as const;
